...
char *a1[20][4] = {
	...
	{"два","два","две","двое"},
	{"три","три","три","трое"},
	{"четыре","четыре","четыре","четверо"},
	{"п€ть","п€ть","п€ть","п€теро"},
	{"шесть","шесть","шесть","шестеро"},
	{"семь","семь","семь","семеро"},
	{"восемь","восемь","восемь","восьмеро"},
	{"дев€ть","дев€ть","дев€ть","дев€теро"},
	{"дес€ть","дес€ть","дес€ть","дес€теро"},
	{"одиннадцать","","",""},
	{"двенадцать","","",""},
	{"тринадцать","","",""},
	{"четырнадцать","","",""},
...
char *aExp[5][4] = {
	{"2","триллион","триллиона","триллионoв"},
	{"2","миллиард","миллиарда","миллиардов"},
	{"2","миллион","миллиона","миллионов"},
	{"3","тыс€ча","тыс€чи","тыс€ч"},
	{"0","","",""}
};
